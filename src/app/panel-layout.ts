...
export class PanelLayoutManager implements AppModule {
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header" role="banner">
        ...
        return `
          ...
          <span class="logo">STEALTHNET MONITOR</span><span class="logo-mobile">StealthNet Monitor</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://github.com/Stealthnettech/worldmonitor" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}" aria-label="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
        ...
        <div class="mobile-menu-footer-links">
          ${SELF_HOSTED ? '' : referenceLinksHtml}
        </div>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">STEALTHNET MONITOR</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; built on <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener" class="site-footer-credit">World Monitor</a> (AGPL-3.0)</span>
          </div>
        </div>
        <nav aria-label="World Monitor references">
          ${SELF_HOSTED ? '' : referenceLinksHtml}
          <a href="https://github.com/Stealthnettech/worldmonitor" target="_blank" rel="noopener">GitHub</a>
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} StealthNetTech</span>
      </footer>
  ...
  private async createPanels(): Promise<void> {
    ...
    const reapply = () => applyProBlockGating(!SELF_HOSTED && hasPremiumAccess(getAuthState()));
    reapply();
